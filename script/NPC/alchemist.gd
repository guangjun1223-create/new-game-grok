# Script AlchemistNPC.gd
extends StaticBody2D

signal alchemist_panel_requested
...
func _ready():
	...
	PlayerStats.register_alchemist_npc(self)
...
func _input_event(_viewport, event, _shape_idx):
	...
	if event is InputEventMouseButton and event.button_index == MOUSE_BUTTON_LEFT and event.is_pressed():
		...
		alchemist_panel_requested.emit()
		print("DEBUG: Alchemist clicked!") # Dòng print để kiểm tra
